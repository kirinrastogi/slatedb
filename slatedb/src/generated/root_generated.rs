...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_COMPACTION_SPEC: u8 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_COMPACTION_SPEC: [CompactionSpec; 4] = [
  CompactionSpec::NONE,
...
impl CompactionSpec {
  ...
  pub const LeveledCompactionSpec: Self = Self(3);
...
impl<'a> LeveledCompactionSpec<'a> {
  pub const VT_SORTED_RUNS: flatbuffers::VOffsetT = 4;
  pub const VT_DESTINATION: flatbuffers::VOffsetT = 6;
  pub const VT_SR_SST_SELECTIONS: flatbuffers::VOffsetT = 8;
  pub const VT_SEGMENT: flatbuffers::VOffsetT = 10;
  ...
  pub fn segment(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(LeveledCompactionSpec::VT_SEGMENT, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LeveledCompactionSpecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_segment(&mut self, segment: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LeveledCompactionSpec::VT_SEGMENT, segment);
  }
  #[inline]
